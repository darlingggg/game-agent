        ...
        <div class="project-grid">
          <article v-for="project in projects" :key="project.id" class="project-card">
            ...
            <div class="project-card-footer">
              ...
              <button type="button" class="project-card-enter">进入项目 →</button>
            </div>
          </article>

          <button type="button" class="project-card project-card--create">
            ...
            <p class="project-create-desc">创建一个新的工具创作项目。</p>
          </button>
        </div>
      </main>
    </div>
